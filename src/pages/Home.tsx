...
const Home = () => {
    ...
    return <div className="h-screen flex flex-col space-y-6 items-center justify-center">
        ...
        <div className="flex flex-wrap space-x-4 items-center justify-center">
            <button onClick={toggleSidebarHandler} className="w-28 h-28 sm:w-32 sm:h-32 flex flex-col items-center justify-center space-y-2 transition duration-200 bg-secondary/10 rounded-lg hover:bg-primary hover:text-white mb-4">
                <ViewFinder className="w-6 sm:w-10" />
                <p className="text-sm px-2">View contacts</p>
            </button>

            <Link to="/create" className="w-28 h-28 sm:w-32 sm:h-32 flex flex-col items-center justify-center space-y-2 transition duration-200 bg-secondary/10 rounded-lg hover:bg-primary hover:text-white mb-4">
                <UserPlus className="w-6 sm:w-10" />
                <p className="text-sm px-2">Create contact</p>
            </Link>

            <button className="w-28 h-28 sm:w-32 sm:h-32 flex flex-col items-center justify-center space-y-2 transition duration-200 bg-secondary/10 rounded-lg hover:bg-primary hover:text-white mb-4">
